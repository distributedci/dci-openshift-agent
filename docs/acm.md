...
| dci_gitops_branch                | No       | HEAD       | The branch of the repo to use as a source <sup>1</sup>
...
# TODO:
# dci_gitops_gh_token              | No       | None       | The GitHub token to use in the repository.
# dci gitops_gh_username           | No       | None       | The GitHub username to use in the repository.
