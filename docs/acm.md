...
| dci_spoke_manifest_files         | No       | []      | A list of rendered manifest that must be applied to the Hub cluster before spoke installation. ie: pull_secrets, BMC credentials, etc.
