...
* For disconnected environments, the [Gitea image (tag: latest-rootless)](https://docker.com/gitea/gitea) must be mirrored to registry running in the restricted network.
