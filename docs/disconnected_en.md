...
| ----------------------- | -------- | ------------- | ------ |---------------------------------------------------- |
| [all:vars] | dci_disconnected | True | String | Main variable to specify this is a disconnected environment |
...
| [all:vars] | pullsecret | Optional | String | Content of the pull secret as downloaded from from https://cloud.redhat.com/openshift/install/metal/user-provisioned, useful when running a deployment without DCI.
