...
* Stable builds are stored under
  `https://mirror.openshift.com/pub/openshift-v<major>/clients/ocp`
  (for example
  [openshift-v4](https://mirror.openshift.com/pub/openshift-v4/clients/ocp)
  or
  [openshift-v5](https://mirror.openshift.com/pub/openshift-v5/clients/ocp))
* RC and Development/nightly builds are stored under
  `https://mirror.openshift.com/pub/openshift-v<major>/clients/ocp-dev-preview`
...
OpenShift Release Types documentation for the relevant major stream under
`https://mirror.openshift.com/pub/openshift-v<major>/`
(for example
[OpenShift_Release_Types.pdf for v4](https://mirror.openshift.com/pub/openshift-v4/OpenShift_Release_Types.pdf)).
...
identified (`<major>` is the OCP major version such as `3`, `4`, or `5`):

| Build type    | DCI Tag           | OCP Mirror Base URL                                                   | Quay.io Namespace                                 |
|---------------|-------------------|-----------------------------------------------------------------------|---------------------------------------------------|
| Stable        | `build:ga`        | mirror.openshift.com/pub/openshift-v\<major\>/clients/ocp             | quay.io/openshift-release-dev/ocp-release         |
| Candidate     | `build:candidate` | mirror.openshift.com/pub/openshift-v\<major\>/clients/ocp-dev-preview | quay.io/openshift-release-dev/ocp-release         |
| Dev           | `build:dev`       | mirror.openshift.com/pub/openshift-v\<major\>/clients/ocp-dev-preview | quay.io/openshift-release-dev/ocp-release-nightly |
