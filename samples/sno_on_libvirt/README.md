...
If SNO is deployed using DCI, the dci-openshift-agent will create 2 users for the API/GUI. Please review {{ dci_cluster_configs_dir }}/ocp_creds.txt file for details and change the passwords if needed.

In case SNO is deployed using the standalong mode, please follow the process below to create a local user for the GUI/API.
