...
| must_gather_mirror_list           | False    | String |["registry.redhat.io/openshift4/ose-must-gather"] | List of must-gather images to mirror on a disconnected cluster local registry. |
