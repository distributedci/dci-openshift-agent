...
| sriov\_installplan\_approval\_mode | False    | String  | Automatic                                        | Install plan approval mode for the SR-IOV operator, set to `Manual` if non-automatic updates are desired |
