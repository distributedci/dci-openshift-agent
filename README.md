...
5. You should see your newly created remoteci in the list, you can get
   ...
   Authentication column. You will need these to [configure your
   jumpbox](#jumpbox-configuration) further down
...
To configure your DCI job pipelines, you need to install `dci-pipeline`. Instructions at [python-pipeline documentation](../python-dcipipeline/).

Here is an example of a pipeline job defintion for `dci-openshift-agent`:
