...
| enable_gitops                   | False    | Boolean | False                                                          | Configures GitOps operator to support Kustomize and PolicyGenerator. Use `dci_gitops_ztp_tag` `dci_gitops_mce_tag` to override the tags for the required images. See [setup_gitops](https://github/redhatci/ansible-collections-redhatci-ocp/roles/setup_gitops) for details.
