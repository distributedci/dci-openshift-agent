...
\* [Here](https://docs.openshift.com/container-platform/4.7/support/gathering-cluster-data.html) you can find information on the available must-gather images. Also, bear in mind that authentication may be needed to retrieve the images.
