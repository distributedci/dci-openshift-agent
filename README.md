...
Some workloads may require an object Object Storage provided. An A [Minio](https://min.io/) instance can be deployed on the OCP cluster by setting `true` the `enable_minio` flag.
