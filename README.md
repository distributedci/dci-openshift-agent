...
| enable_odf                      | False    | Boolean | False                                                          | Deploys the ODF Operator and its dependencies(ocs, lso, mcg, odf-csi-addons).
| storage_cluster                 | False    | Boolean | False                                                          | Creates a storage cluster using Red Hat OpenShift Data Foundation operators. Staring OCP 4.10, ODF replaces OCS. See: [Openshift Data Foundation](https://access.redhat.com/documentation/
| cnf_test_suites                 | False    | List    |                                                                | List of CNF Tests to perform: ['sctp','ptp','performance','sriov','dpdk']
en-us/red_hat_openshift_data_foundation/4.9/html/deploying_openshift_data_foundation_using_bare_metal_infrastructure/preparing_to_deploy_openshift_data_foundation) documentation for details about the nodes requirements.
