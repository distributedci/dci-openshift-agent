...
| enable_lvms                     | False    | Boolean | False                                                          | Configures LVM Storage operator to setup a local disk with LVM. Use `dci_lvms_dev_class_name`, `dci_lvms_dev_selector_path`, and `dci_lvms_storage_class` to customize setup. See [setup_lvms](https://github/redhatci/ansible-collections-redhatci-ocp/roles/setup_lvms) for details.
...
| dci_lvms_dev_selector_path      | False    | String  |                                                                | Disk path pattern for device selection for LVMS Operator
