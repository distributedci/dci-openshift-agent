...
| dci\_teardown\_on\_failure         | False    | Boolean | True                                             | Whether or not execute the teardown hook on a failure          |
| dci\_teardown\_on\_success         | False    | Boolean | False                                            | Whether or not execute the teardown hook on success            |
