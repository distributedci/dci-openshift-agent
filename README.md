...
| opm_mirror_list                    | False    | List    | ""                                               | List of operators to be mirrored in disconnected environments. Supported values are: performance-addon-operator,  sriov-network-operator, kubevirt-hyperconverged,elasticsearch-operator, cluster-logging     |
...
Please see the table above for the variables names to control the Operators installation.
