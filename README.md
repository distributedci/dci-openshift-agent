...
| tests_to_verify | False | List | undefined | List of expected test results. When defined, it triggers the validation of actual test results against the expectations. Please check [verify-tests readme](https://github.com/redhatci/ocp/blob/main/roles/verify_tests/README.md) to get more details and an example of the configuration.
