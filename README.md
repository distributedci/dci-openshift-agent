...
| dci_set_console_pass            | False    | Boolean | False                                                          | Enable core user with password authentication from the BMC, this does not work with SSH. Password will be set to `dciconsole`.
| dci_console_pass                | False    | String  | dciconsole                                                     | Password for the core user if `dci_set_console_pass` is true.
