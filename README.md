...
| dci_enable_proxy                | False    | Boolean | False                                                         | Enable the use of dci_http_proxy, dci_https_proxy and dci_no_proxy_list. Only for IPI, UPI and SNO installs
| dci_http_proxy                  | False    | String  | ""                                                            | URL of the HTTP proxy server to connect through.
| dci_https_proxy                 | False    | String  | ""                                                            | URL of the HTTPS proxy server to connect through.
| dci_no_proxy_list               | False    | String  | ""                                                            | Comma separated list of hosts/domains/IPv4 CIDRs/ports that should not go through the proxy. Wildcard is represented with '.' for example .domain is wildcard for *.domain.
