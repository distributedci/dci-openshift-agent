...
| dci_must_gather_images           | False    | List   |["registry.redhat.io/openshift4/ose-must-gather"] | List of the registry names for the must-gather images to use when getting the logs.\* |
