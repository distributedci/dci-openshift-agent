...
| enable_logs_stack               | False    | Boolean | False                                                          | Enables the OCP cluster logging subsystem using the Loki and ClusterLogging Operator. When enabled, the following variables (logs_*) are required.
...
| logs_s3_bucket                  | False    | String  | undefined                                                      | Object Storage bucket name.
| logs_s3_endpoint                | False    | String  | undefined                                                      | Object Storage endpoint.
| logs_s3_region                  | False    | String  | undefined                                                      | Object Storage region.
