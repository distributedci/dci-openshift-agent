...
| dci_additional_trust_bundle     | False    | String  | ""                                                             | Path to an additional CA certificate to be added to the ConfigMap `image.config.openshift.io\cluster` for the `local_registry_host:local_registry_port`.
