...
Requires: ansible-collection-redhatci-ocp >= 0.5.0
...
%changelog
* Mon Mar 18 2024 Tony Garcia <tonyg@redhat.com> 0.13.0-1
- Require ansible-collection-redhatci-ocp >= 0.5.0 with kubernetes.core
