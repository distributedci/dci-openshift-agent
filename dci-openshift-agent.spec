...
%changelog
* Thu Aug 13 2026 Frederic Lepied <flepied@redhat.com> 1.35.EPOCH-1.VERS
- Resolve must-gather short names via CSV relatedImages before mirror and log collection
- Requires ansible-collection-redhatci-ocp >= 4.3.0
...
* Wed Jan 21 2026 Beto Rdz <josearod@redhat.com> - 1.23.EPOCH-VERS
- Version bump for override ICS in role generate_manifests

* Tue Jan 20 2026 Beto Rdz <josearod@redhat.com> - 1.22.EPOCH-VERS
- Version bump for stop uploading credential files

* Tue Jan 20 2026 Beto Rdz <josearod@redhat.com> - 1.21.EPOCH-VERS
...
* Thu Sep 25 2025 Frederic Lepied <flepied@redhat.com> - 1.18.EPOCH-VERS
