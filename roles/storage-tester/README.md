...
For more information on storage classes, see [the OCP documentation](https://docs.openshift.com/container-platform/4.8/post_installation_configuration/storage-configuration.html#defining-storage-classes_post-install-storage-configuration).
