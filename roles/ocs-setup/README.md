...
# local_storage_operator_catalog_source: "registry.redhat.io/redhat/redhat-operator-index:v4.8"
#
...
# (Optional) registry catalog URL with index from where to pull the image
# ocs_operator_image_catalog_source: "registry.redhat.io/redhat/redhat-operator-index:v4.8"
#
# (Required) Channel versions to use, namespace and operators names
