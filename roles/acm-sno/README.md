...
|acm_user_registry                       |Undefined                      |Yes, for disconnected environments |registries.conf file to be injected to the spoke nodes. The entries will be merged with the ones obtained from the Hub cluster.|
